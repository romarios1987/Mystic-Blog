    ...
    <div class="row">
        <nav class="admin-nav">
            <div class="nav-wrapper">
                <a href="index.php" class="brand-logo"><img src="../images/tomcat.svg" alt="alt"><span>MysticBlog</span></a>
                ...
                <div class="wrap-dropdown-head">
                    <a class="dropdown-button right" href="#!" data-activates="dropdown1"><i class="fa fa-user"></i>
                        Привет <span>Admin</span> !<i class="material-icons right">arrow_drop_down</i></a>
